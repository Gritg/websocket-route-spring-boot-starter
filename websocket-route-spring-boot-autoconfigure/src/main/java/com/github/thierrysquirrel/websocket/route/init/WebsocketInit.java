...
public class WebsocketInit {
    ...
    @PostConstruct
    public void init() {
        WebsocketInitExecution.init (websocketRouteProperties.getUrl (),
                websocketRouteProperties.getMaxFramePayloadLength (),
                websocketRouteProperties.getReadTimeoutMilli ());
    }
}
