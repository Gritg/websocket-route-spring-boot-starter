...
import com.github.thierrysquirrel.websocket.route.netty.thread.execution.HttpServerHandshakeThreadExecution;
...
public class HttpServerHandlerFactoryExecution {
    ...
    public static void handshake(Channel serverChannel, FullHttpRequest request, int maxFramePayloadLength, int readTimeoutMilli){
        HttpServerHandshakeThreadExecution handshakeThreadExecution=new HttpServerHandshakeThreadExecution (serverChannel, request, maxFramePayloadLength, readTimeoutMilli);
