...
public class ThreadPoolFactory {
    ...
    public static ThreadPoolExecutor createWebsocketClientBusinessThreadPool() {
        ThreadFactory threadFactory = new ThreadFactoryBuilder ()
                .setNameFormat (ThreadPoolConstant.WEBSOCKET_CLIENT_BUSINESS).build ();
        return new ThreadPoolExecutor (ThreadPoolConstant.WEBSOCKET_CLIENT_BUSINESS_CORE_POOL_SIZE,
                ThreadPoolConstant.WEBSOCKET_CLIENT_BUSINESS_MAXIMUM_POOL_SIZE,
                ThreadPoolConstant.WEBSOCKET_CLIENT_BUSINESS_KEEP_ALIVE_TIME,
                TimeUnit.MILLISECONDS,
                new LinkedBlockingQueue<> (),
                threadFactory,
                new ThreadPoolExecutor.AbortPolicy ()
